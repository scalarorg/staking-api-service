...
import (
	...
	db "github.com/scalarorg/staking-api-service/internal/db"
	mock "github.com/stretchr/testify/mock"

	model "github.com/scalarorg/staking-api-service/internal/db/model"

	types "github.com/scalarorg/staking-api-service/internal/types"
)
...
// DeleteDApp provides a mock function with given fields: ctx, ID
func (_m *DBClient) DeleteDApp(ctx context.Context, ID string) error {
...
// FindDAppStats provides a mock function with given fields: ctx, paginationToken
func (_m *DBClient) FindDAppStats(ctx context.Context, paginationToken string) (*db.DbResultMap[*model.DAppDocument], error) {
	ret := _m.Called(ctx, paginationToken)

	if len(ret) == 0 {
		panic("no return value specified for FindDAppStats")
	}

	var r0 *db.DbResultMap[*model.DAppDocument]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*db.DbResultMap[*model.DAppDocument], error)); ok {
		return rf(ctx, paginationToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *db.DbResultMap[*model.DAppDocument]); ok {
		r0 = rf(ctx, paginationToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*db.DbResultMap[*model.DAppDocument])
		}
	}
...
// SaveDApp provides a mock function with given fields: ctx, ChainName, AddressHex, PublicKeyHex
...
// TransitionToBurnWithoutDAppState provides a mock function with given fields: ctx, vaultTxHashHex
func (_m *DBClient) TransitionToBurnWithoutDAppState(ctx context.Context, vaultTxHashHex string) error {
	ret := _m.Called(ctx, vaultTxHashHex)

	if len(ret) == 0 {
		panic("no return value specified for TransitionToBurnWithoutDAppState")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string) error); ok {
		r0 = rf(ctx, vaultTxHashHex)
	} else {
		r0 = ret.Error(0)
	}
...
// TransitionToBurningState provides a mock function with given fields: ctx, vaultTxHashHex
func (_m *DBClient) TransitionToBurningState(ctx context.Context, vaultTxHashHex string) error {
	ret := _m.Called(ctx, vaultTxHashHex)

	if len(ret) == 0 {
		panic("no return value specified for TransitionToBurningState")
	}
...
// TransitionToSlashingOrLostKeyState provides a mock function with given fields: ctx, vaultTxHashHex
func (_m *DBClient) TransitionToSlashingOrLostKeyState(ctx context.Context, vaultTxHashHex string) error {
	ret := _m.Called(ctx, vaultTxHashHex)

	if len(ret) == 0 {
		panic("no return value specified for TransitionToSlashingOrLostKeyState")
	}
